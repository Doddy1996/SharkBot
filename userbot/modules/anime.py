...
@register(events.NewMessage(pattern=r"^.action", outgoing=True))
...
@register(events.NewMessage(pattern=r"^.harem", outgoing=True))
...
@register(events.NewMessage(pattern=r"^.mecha", outgoing=True))
...
@register(events.NewMessage(pattern=r"^.romance", outgoing=True))
...
@register(events.NewMessage(pattern=r"^.isekai", outgoing=True))
...
@register(events.NewMessage(pattern=r"^.adventure", outgoing=True))
...
@register(events.NewMessage(pattern=r"^.slice", outgoing=True))
...
"""CMD_HELP.update({
        "Anime":"
	\n\n.action <number of times(integer)>\
        \nUsage: Gets Some anime genre action.\
	\n\n.harem <number of times(integer)>\
	\nUsage: Gets Some anime genre harem.\
	\n\n.mecha <number of times(integer)>\
	\nUsage: Gets Some anime genre mecha.\
	\n\n.romance <number of times(integer)>\
	\nUsage: Gets Some anime genre romance.\
	\n\n.isekai <number of times(integer)>\
	\nUsage: Gets Some anime genre isekai.\
	\n\n.adventure <number of times(integer)>\
	\nUsage: Gets Some anime genre adventure.\
	\n\n.slice <number of times(integer)>\
	\nUsage: Gets Some anime genre Slice of Life."
    })     
"""
