...
@register(pattern=r"^.action", outgoing=True)
...
@register(pattern=r"^.harem", outgoing=True)
async def action(event):
    if event.fwd_from:
        return   
...
@register(pattern=r"^.mecha", outgoing=True)
async def action(event):
    if event.fwd_from:
        return   
    number_of_times = event.text[7:]
...
@register(pattern=r"^.romance", outgoing=True)
async def action(event):
    if event.fwd_from:
        return   
...
@register(pattern=r"^.isekai", outgoing=True)
async def action(event):
    if event.fwd_from:
        return   
    number_of_times = event.text[8:]
...
@register(pattern=r"^.adventure", outgoing=True)
async def action(event):
    if event.fwd_from:
        return   
...
@register(pattern=r"^.slice", outgoing=True)
async def action(event):
    if event.fwd_from:
        return   
    number_of_times = event.text[7:]
